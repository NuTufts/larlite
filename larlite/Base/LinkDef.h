...
#pragma link C++ enum larlite::data::DataTypeCategory_t;
#pragma link C++ enum larlite::data::RunDataType_t;
#pragma link C++ enum larlite::data::SubRunDataType_t;

#pragma link C++ function const std::string& larlite::data::GetProductName(const larlite::data::DataType_t);
