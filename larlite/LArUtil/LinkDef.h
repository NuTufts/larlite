...
#pragma link C++ class larlite::larutil::OpDetGeo+;
#pragma link C++ class larlite::larutil::WireGeo+;
#pragma link C++ class larlite::larutil::PlaneGeo+;
#pragma link C++ class larlite::larutil::TPCGeo+;
#pragma link C++ class larlite::larutil::CryoGeo+;
#pragma link C++ class std::vector<larlite::larutil::OpDetGeo>+;
#pragma link C++ class std::vector<larlite::larutil::WireGeo>+;
#pragma link C++ class std::vector<larlite::larutil::PlaneGeo>+;
#pragma link C++ class std::vector<larlite::larutil::TPCGeo>+;
#pragma link C++ class std::vector<larlite::larutil::CryoGeo>+;
#pragma link C++ class larlite::larutil::Geometry+;
