...
#include "larlite/Geometry/geo_vectors_utils.h" // geo::vect::dot()
...
namespace larlite::geo::details {
  ...
  } // larlite::geo::details::LineClosestPointImpl()
  ...
  } // larlite::geo::details::LineClosestPointWithUnitVectorsImpl()
...
// -----------------------------------------------------------------------------
template <typename Point, typename Vector>
larlite::geo::IntersectionPointAndOffsets<Point> larlite::geo::LineClosestPointAndOffsets(
  Point const& startA, Vector const& dirA,
  Point const& startB, Vector const& dirB
) {
...
} // larlite::geo::LineClosestPointAndOffsets()


// -----------------------------------------------------------------------------
template <typename Point, typename Vector>
Point larlite::geo::LineClosestPoint(
  Point const& startA, Vector const& dirA,
  Point const& startB, Vector const& dirB
) {
  return details::LineClosestPointImpl(startA, dirA, startB, dirB, nullptr);
} // larlite::geo::LineClosestPoint()


// -----------------------------------------------------------------------------
template <typename Point, typename UnitVector>
larlite::geo::IntersectionPointAndOffsets<Point>
larlite::geo::LineClosestPointAndOffsetsWithUnitVectors(
  Point const& startA, UnitVector const& dirA,
  Point const& startB, UnitVector const& dirB
) {
...
// -----------------------------------------------------------------------------
template <typename Point, typename UnitVector>
Point larlite::geo::LineClosestPointWithUnitVectors(
  Point const& startA, UnitVector const& dirA,
  Point const& startB, UnitVector const& dirB
) {
